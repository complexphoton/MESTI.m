...
% Use angular spectrum propagation (ASP) to compute intensity profile away from 
% the metalens, for incident angles of 0  degree and 30 degrees. 
...
% Here we
% 
% 1. Calculate the transmission efficiency and field in the focal plane for 
% an ideal lens.
% 
% 2. Loop over different incident angles to calculate the transmission efficiency 
% and Strehl ratio of the hyperbolic metalens.
